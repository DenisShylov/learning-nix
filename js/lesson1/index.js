...
// Task 2
// В случае const BIRTHDAY можно и нужно делать название в верхнем регистре, потому что в данном случае значение переменной трудно запомнить.
// В случае с const age я считаю что именовать переменную в верхнем регистре не нужно.
